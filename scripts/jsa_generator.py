...
def generate_jsa(job_type="高处作业", company="", location="", output_file=None):
    ...
    lines.append("| 作业人员 | __________ |")
    lines.append("| 监护人 | __________ |")
    lines.append("| 作业日期 | ____年____月____日 ____:____ ~ ____:____ |")
    lines.append("")
    lines.append("## 风险分析")
    lines.append("")
    lines.append("| 序号 | 作业步骤 | 潜在风险 | 控制措施 | 责任人 | 确认 |")
    lines.append("|------|---------|---------|---------|------|------|")
    ...
    lines.append("## 作业审批")
    lines.append("")
    lines.append("- **作业负责人**: ________ | **日期**: ________")
    lines.append("- **安全监护人**: ________ | **日期**: ________")
    lines.append("- **EHS 审批**: ________ | **日期**: ________")
    lines.append("")
    lines.append("## 完工确认")
    lines.append("")
    lines.append("- 作业现场已清理: □ 是 □ 否")
    lines.append("- 安全设施已恢复: □ 是 □ 否")
    lines.append("- 作业票已关闭: □ 是 □ 否")
    lines.append("- **确认人**: ________ | **日期**: ________")
    lines.append("")
    lines.append("---")
